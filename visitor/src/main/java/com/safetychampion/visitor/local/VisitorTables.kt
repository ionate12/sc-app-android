...
data class VisitorActivityDB(
    ...
    fun toRecentActivityCell(): RecentActivityCell {
        val evidence = toVisitorEvidence()
        return RecentActivityCell(_id,
    ...
    fun toVisitorEvidence(): VisitorEvidence = GsonHelper.getGson().fromJson(data, VisitorEvidence::class.java).apply { this.token = this@VisitorActivityDB.token }
